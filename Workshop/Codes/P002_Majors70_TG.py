...
#%% Reads the dataframe
Ex0= pd.read_csv(main+'/Data/ModelReady/Top70_Majors_YR2_FALL_CURRICULUM_1_EOS.csv',low_memory=False)
...
cols = list(Ex1)
cols.insert(0, cols.pop(cols.index('YR2_FALL_CURRICULUM_1_EOS')))
Ex2=Ex1.loc[:,cols]
...
joblib.dump(best_rf_model, main+'\Results\F01_Majors\Models\RandomForest_70.pkl')   
...
Results.to_csv(main+'\Results\F01_Majors\Accuracies\Majors_70_Accuracies.csv')
...
ax.yaxis.grid(True)
plt.savefig(main+'/Results/F01_Majors/Graphs/Side_by_Side_Majors70.png')
...
plt.savefig(main+"/Results/F01_Majors/Graphs/FeatureImportanceRF_Majors70.png")
